...
| ID | 항목 | 채택 여부 |
|---|---|---|
| B-01 | 프로젝트 언어별 필터링 버튼 (`filter`) -- F-47 / F-57 4번째 흐름과 동시 충족 | ✅ 채택 (Phase 5) |
| B-02 | Hero 타이핑 효과 | ✅ 채택 (Phase 5) |
| B-03 | Formspree / EmailJS 실제 전송 | ✖ 미채택 (감점 없음) |
| B-04 | `prefers-color-scheme` 시스템 다크모드 감지 | ✅ 채택 (Phase 2) |
