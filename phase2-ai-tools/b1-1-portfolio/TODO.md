...
최종 업데이트: 2026-09-15
현재 위치: **개념 A 진행 중 (A4 예측 완료·관찰 보류 / A5 다음)**
...
- [~] A4 CSS 변수 (`:root`) -- 예측·해설 완료, **관찰 보류** (2026-09-15)
- [~] **A5 Flexbox (1차원)** ◀ 여기부터 -- 실습 파일 + 사전 지식 5개 + 예측 Q1~Q3 제시, **답변 대기** (2026-09-15)
  - Q1 flex는 직접 자식까지만 (nav > ul > li) · Q2 `column`에서 justify/align 축 전환 · Q3 400px에 200px×3 (nowrap 축소 / wrap 줄바꿈)
