# Knowledge Base - 핵심 개념 SSOT

> 모든 미션에서 학습한 개념의 단일 진실 소스(SSOT).
> 개념 기록은 이곳에만 한다. 다른 곳에 중복 기록하지 않는다.
...
| _template-mission-concepts.md | 미션 개념 기록 템플릿 |
| _template-checkpoint.md | grill-me/grill-with-docs 체크포인트 템플릿 |
